...
#Get Project ID
openfile=open('C:/Users/darkk/OneDrive/NUS/Y3S2/IS3107/proj/test-proj-378801-e260b3ef768e.json')
jsondata=json.load(openfile)
openfile.close()
project_id = jsondata['project_id']

# Construct a BigQuery client object.
credentials_path = 'C:/Users/darkk/OneDrive/NUS/Y3S2/IS3107/proj/test-proj-378801-e260b3ef768e.json'
...
def setupDataset():
    ...
    Sets up the dataset
    '''
    dataset = ["yfinance_data_raw", "stock_info", 'twitter_data'] #list of datasets to make 
